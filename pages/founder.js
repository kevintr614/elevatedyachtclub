...
if(process.env.PRODUCTION==1) var hlink='https://etherscan.io/address/';
else var hlink='https://rinkeby.etherscan.io/address/';
...
export default function Mint() {
  ...
  const MintHandler = async () => {
    ...
    const { success, status } = await StartMint(mintAmount)
  ...
  return (
	...
	<Head>
           <title>Elevated Yacht Club</title>
	   <link rel="icon" type="image/png" href="favicon.png" />
        ...
        />
        <WinterCheckout projectId={7038} showModal={showWinter} production={true} mintQuantity={mintAmount} extraMintParams={{id: 0}} priceFunctionParams={{pid: 0}}/>
        <div className="flex flex-col items-center justify-center h-full w-full px-2 md:px-10">
          ...
          <div className="relative z-1 md:max-w-3xl w-full bg-gray-900/90 filter backdrop-blur-sm py-4 rounded-md px-2 md:px-10 flex flex-col items-center">
            ...
            <img src="/images/elevated.png" className="object-cover w-full "/>
            ...
            {paused ? 'Mint is Paused' : 'Founder Pass!'}
              ...
              <div className="font-coiny flex items-center justify-between w-full">
                ...
                <div className="border-t border-b py-4 mt-9 w-full">
                  <div className="w-full text-xl font-coiny flex items-center justify-between text-brand-yellow">
                    ...
                    <div className="flex items-center space-x-3">
                      <p>
                        {Number.parseFloat((mintPrice / (10**18)) * mintAmount).toFixed(2)}{' '} ETH
                      </p>{' '}
                ...
                {wallet ? (
                  <button
                    ...
                    } font-coiny mt-3 w-full px-6 py-3 rounded-md text-2xl text-white  mx-4 tracking-wide uppercase`}
                    disabled={paused || isMinting}
                    onClick={MintHandler}
                  >
                    {isMinting ? 'Minting...' : 'Mint '+mintAmount}
                  </button>
                ) : (
                  <button
                    className="font-coiny mt-3 w-full bg-gradient-to-br from-brand-purple to-brand-pink shadow-lg px-6 py-3 rounded-md text-2xl text-white hover:shadow-pink-400/50 mx-4 tracking-wide uppercase"
                    onClick={() => connect()}
                  >
                    Connect Wallet
                  </button>
                ...
                <button 
                className="font-coiny mt-3 w-full bg-gradient-to-br from-brand-purple to-brand-pink shadow-lg px-6 py-3 rounded-md text-2xl text-white hover:shadow-pink-400/50 mx-4 tracking-wide uppercase"
                onClick={toggleWinter} >Credit Card</button>
              </div>
            ...
            <div className="border-t border-gray-800 flex flex-col items-center mt-10 py-2 w-full">
              ...
              <a
                href={`${hlink+config.contractAddress}#readContract`}
                target="_blank"
            ...
            <div className="flex  ">
              <a target="_blank" href="https://twitter.com/ElevatedYC" ><img src="/images/twitter.ico" width="50px"/></a>&emsp;
              <a target="_blank" href="https://opensea.io/collection/elevatedyachtclub" ><img src="/images/opensea.png" width="50px"/></a>&emsp;
              <a target="_blank" href="http://instagram.com/elevatedyachtclub" ><img src="/images/instagram.png" width="50px"/></a>
            </div>
          </div>
        </div>
